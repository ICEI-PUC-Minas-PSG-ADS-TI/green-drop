package br.com.pucminas.image_service.adapter.in.web.doc;
...
public interface ImageControllerDoc {
    ...
    ResponseEntity<URI> upload(@Parameter(description = "Arquivo de imagem (PNG, JPG, etc.)", required = true) @RequestPart("photo") MultipartFile file) throws IOException;
